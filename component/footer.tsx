  ...
  return (
    <>
      <style>{`
        ...
        .vs-wrap { font-family:"Outfit",sans-serif; background:#fff; }
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
            ...
            <div className="lg:col-span-5 flex flex-col gap-7">
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <a href="tel:+919876543210" target="_blank" rel="noopener noreferrer" className="vs-btn-call flex items-center justify-center gap-2 py-3.5 rounded-2xl text-white font-semibold text-sm">
              ...
              <div className="flex flex-col gap-2.5">
                ...
                <div className="grid grid-cols-2 gap-2.5">
                  <div className="vs-info flex items-center gap-3 px-4 py-3.5 rounded-2xl" style={{background:"#fafafa",border:"1px solid rgba(0,0,0,0.06)",boxShadow:"0 2px 10px rgba(0,0,0,0.03)"}}>
                    <div className="w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0" style={{background:"rgba(42,157,143,0.07)"}}>
                      <svg width="17" height="17" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="10" stroke="#2a9d8f" strokeWidth="2"/><path d="M12 6v6l4 2" stroke="#2a9d8f" strokeWidth="2" strokeLinecap="round"/></svg>
                    </div>
                    <div>
                  ...
                  <div className="vs-info flex items-center gap-3 px-4 py-3.5 rounded-2xl" style={{background:"#fafafa",border:"1px solid rgba(0,0,0,0.06)",boxShadow:"0 2px 10px rgba(0,0,0,0.03)"}}>
                    <div className="w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0" style={{background:"rgba(201,169,110,0.07)"}}>
                      <svg width="17" height="17" viewBox="0 0 24 24" fill="none"><path d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" stroke="#c9a96e" strokeWidth="2" strokeLinecap="round"/></svg>
                    </div>
                    <div>
              ...
              <div className="relative w-full" style={{height:"320px"}}>
                ...
                {/* ambient glows */}
                <div className="absolute pointer-events-none" style={{bottom:"-20px",left:"-20px",width:"180px",height:"180px",borderRadius:"50%",background:"radial-gradient(circle,rgba(42,157,143,0.13) 0%,transparent 70%)",zIndex:0}} />
                <div className="absolute pointer-events-none" style={{top:"-10px",right:"-10px",width:"130px",height:"130px",borderRadius:"50%",background:"radial-gradient(circle,rgba(201,169,110,0.14) 0%,transparent 70%)",zIndex:0}} />

                {/* decorative gold ring */}
                <div className="vs-ring absolute pointer-events-none" style={{top:"14px",left:"37%",width:"52px",height:"52px",borderRadius:"50%",border:"1.5px solid rgba(201,169,110,0.45)",zIndex:1}} />
                ...
                <div className="vs-img1 absolute overflow-hidden" style={{top:0,left:0,width:"56%",height:"100%",borderRadius:"100px 20px 20px 20px",boxShadow:"0 20px 56px rgba(0,0,0,0.14)",zIndex:2}}>
                  <img src="/contact.avif" alt="Creator Aesthetic Clinic" style={{width:"100%",height:"100%",objectFit:"cover",objectPosition:"top center"}} />
                ...
                <div className="vs-img2 absolute overflow-hidden" style={{bottom:0,right:0,width:"54%",height:"70%",borderRadius:"20px 20px 100px 20px",boxShadow:"0 18px 52px rgba(0,0,0,0.16)",border:"3.5px solid #fff",zIndex:3}}>
                  <img src="/expressive.avif" alt="Dr. Sai — Hair Specialist ECR" style={{width:"100%",height:"100%",objectFit:"cover",objectPosition:"top center"}} />
            ...
            <div className="lg:col-span-7 flex flex-col gap-4 lg:sticky lg:top-8">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2 px-3 py-1.5 rounded-full" style={{background:"rgba(52,211,153,0.08)",border:"1px solid rgba(52,211,153,0.22)"}}>
                  <span className="vs-dot vs-dot-green" />
                  <span style={{fontSize:"11px",fontWeight:600,color:"#2a9d8f"}}>Open Now</span>
                </div>
              </div>
